<?php
$conn = new mysqli("localhost","root","","hack-out");
                        ...
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                <a href="index.php" class="s-header__logo-link">
                                    ...
                                    <img class="s-header__logo-img s-header__logo-img-shrink" src="img/logo-dark.png" alt="Megakit Logo">--> <font style="font-size:25px;color:black;font-family:impact;font-weight:800;text-shadow: 2px 2px 2px white;">Mission Disaster<br></font><font style="font-size:20px;color:#13b1cd;font-family:monospace;font-weight:800;text-shadow: 1px 1px 1px black;">Precautions Before Destructions</font>
                                </a>
                            </div>
                            <div id="video-view">
</div>
